var url = require('url')
  ...
  , phantomScript = __dirname.indexOf('.asar') == -1 ? __dirname + '/webshot.phantom.js' : __dirname.replace('.asar', '.asar.unpacked') + '/webshot.phantom.unpack.js'
...
module.exports = function() {
  ...
  */
  ...
  try {
    defaults.phantomPath = require('phantomjs').path.indexOf('.asar') == -1 ? require('phantomjs').path : require('phantomjs').path.replace('.asar', '.asar.unpacked')
;
  } catch (ex) {}
